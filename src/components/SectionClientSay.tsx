...
const DEMO_DATA = [
  {
    id: 1,
    clientName: "Ayesha Al Mansoori",
    clientAddress: "Dubai, UAE",
    content:
      "The experience was absolutely seamless. Everything looked exactly like the listing. Truly premium service and unforgettable stay in Dubai!",
  },
  {
    id: 2,
    ...
    content:
      "Highly professional service and beautiful property. The hospitality felt world-class and the stay exceeded expectations.",
  },
  {
    id: 3,
    clientName: "Fatima Al Zarooni",
    clientAddress: "Sharjah, UAE",
    content:
      "Everything was clean, modern, and exactly as shown in the pictures. Great attention to detail and excellent customer support.",
  },
];
